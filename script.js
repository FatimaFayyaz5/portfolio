document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        // Remove old click listeners if any, we'll redefine smooth scroll here
            ...
            if (targetElement) {
                ...
                setTimeout(() => {
                    ...
                    window.scrollTo({
                        ...
                        behavior: 'instant' // snap while covered
                    });
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            transitionEl.classList.remove('active', 'slide-out');
                        }, 600); // Wait for slide out to finish
                    }, 100);
                }, 500); // Wait for transition in (0.5s)
            }
        });
    });
            }
    ...
    if (typedTextSpan) {
        const textArray = ['Data Scientist', 'ML Engineer', 'AI Enthusiast'];
